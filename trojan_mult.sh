...
EOF
    ...
    wget https://github.com/ShawnZhang31/troooojan-install/blob/main/fakesite.zip >/dev/null 2>&1
...
EOF
        ...
        wget https://github.com/ShawnZhang31/troooojan-install/blob/main/trojan-cli.zip
